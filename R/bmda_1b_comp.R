#' BMDA 1B Composite Data
#'
#' A dataset from Porites astreoides coral 1B (Hughes et al., 2024) containing age modeled geochemical variables along with in situ climate variables.
