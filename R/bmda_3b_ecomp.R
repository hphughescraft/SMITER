#' BMDA 3B Composite Data
#'
#' A dataset from Porites astreoides coral 3B (Hughes et al., 2024) containing age modeled geochemical variables along with in situ climate variables.

#'
#' @format A data frame with 33 rows and 11 columns:
#' \describe{
#'   \item{Date}{Monthly (decimal dates), ranging from December 2010 to June 2013.}
